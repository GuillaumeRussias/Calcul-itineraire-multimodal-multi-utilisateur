...
class Vertice:
    ...
    def __init__(self,index,neighbours_list,coordinates):
        ...
        self._distance_dijkstra = inf  #distance is by default inf
    ...
    @property
    def distance_dijkstra(self):
        """ Returns the distance. """
        return self._distance_dijkstra
    ...
    # We suppose that the index, the list of neighbours
    # and the coordinates never change.
    ...
    @distance_dijkstra.setter
    def distance_dijkstra(self,d):
        self._distance_dijkstra = d
