...
class Vertice:
    ...
    def __init__(self,neighbours_list,coordinates):
        """ Entry : a list of neighbours represented by a tuple :
    ...
    # We suppose that the list of neighbours and the coordinates never change.
...
#test
vertice0 = Vertice([(1,0),(2,0),(3,0)],(0,0))
vertice1 = Vertice([(0,0),(2,0)],(0,0))
vertice2 = Vertice([(0,0),(1,0)],(0,0))
vertice3 = Vertice([(0,0)],(0,0))
